...
function SecondWindow() {
    ...
    return (
        <div className="second">
            <Search />
            {res ? res.map((item) => <Link key={item.code} {...item} />) : null}
            <div className="second-window">
                <div className="sw-text">
                    <h2>Advanced Statistics</h2>
                    <p className="sw-text-desc">
            ...
            <div className="details">
                ...
                <div className="cart-two">
                    ...
                    <h3>Deteiled Records</h3>
                    <p className="cart-text">
                        Detailed Records Gain insights into who is clicking your links. Knowing when
                ...
                <div className="cart-three">
                    ...
                    <p className="cart-text">
                        Fully Customizable Improve brand awareness and content discoverability
