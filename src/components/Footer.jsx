            ...
            <div className="second-footer">
                ...
                <div className="footer-descriptions">
                    <div className="fr-desc">
                        <h5>Features</h5>
                        <p className="text-footer">Link Shortening</p>
                        <p className="text-footer">Branded Links</p>
                        <p className="text-footer">Analytics</p>
                    </div>
                    <div className="tw-desc">
                        <h5>Resources</h5>
                        <p className="text-footer">Blog</p>
                        <p className="text-footer">Developers</p>
                        <p className="text-footer">Support</p>
                    </div>
                    <div className="th-desc">
                        <h5>Company</h5>
                        <p className="text-footer">About</p>
                        <p className="text-footer">Our Team</p>
